// Profile page JavaScript - Firebase Auth version with Photo Integration
...
function updateNavPhoto(photoURL) {
    ...
    if (photoURL) {
        ...
        if (existingInitials) {
            ...
            profileBtn.insertAdjacentHTML('afterbegin', `<img src="${photoURL}" alt="Profile" class="profile-photo-nav">`);
        } else {
